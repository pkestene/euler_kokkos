...
public:
  ...
  void
  allToAll(void * sendBuf, int sendCount, int sendType, void * recvBuf, int recvCount, int recvType)
    const;

  //! Variable-length gather-scatter
  void
  allToAllv(void * sendBuf,
            int *  sendCount,
  ...
  void
  allReduce(void * input, void * result, int inputCount, int type, int op) const;
  ...
  //! Broadcast
  void
  bcast(void * msg, int length, int type, int src) const;
  ...
  //@{
  void
  send(void * sendBuf, int sendCount, int sendType, int dest, int tag) const;

  void
  recv(void * recvBuf, int recvCount, int recvtype, int source, int tag) const;

  void
  sendrecv(void * sendBuf,
           int    sendCount,
           int    sendType,
           int    dest,
           int    sendtag,
  ...
  MPI_Request
  Isend(void * sendBuf, int sendCount, int sendType, int dest, int tag) const;

  MPI_Request
  Ibsend(void * sendBuf, int sendCount, int sendType, int dest, int tag) const;

  MPI_Request
  Issend(void * sendBuf, int sendCount, int sendType, int dest, int tag) const;

  MPI_Request
  Irsend(void * sendBuf, int sendCount, int sendType, int dest, int tag) const;

  MPI_Request
  Irecv(void * recvBuf, int recvCount, int recvType, int source, int tag) const;
  ...
  static void
  errCheck(int errCode, const std::string & methodName);
