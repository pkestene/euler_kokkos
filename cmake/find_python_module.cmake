...
function(find_python_module module module_u)
  ...
  if(NOT PY_${module_u}_PATH)
    ...
    # A module's location is usually a directory, but for binary modules it's an
    # .so file.
    execute_process(
    ...
    # strip module directories to get the base path abc.foo.bar.xyz -> ...
    # (three dots)
    ...
    if(module_strip GREATER 0)
      ...
      foreach(module_strip_i RANGE 1 ${module_strip})
        string(REGEX REPLACE "/[^/]+$" "" "PY_${module_u}_OUTPUT"
